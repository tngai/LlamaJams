...
/***/ function(module, exports, __webpack_require__) {
	...
	var Playlist = __webpack_require__(204);
			...
			render: function render() {
					return React.createElement(
							...
							React.createElement(
									'div',
									null,
									this.state.showAuth ? React.createElement(Auth, null) : null
							),
							React.createElement(
									'div',
									null,
									this.state.showPlaylist ? React.createElement(Playlist, null) : null
							)
					);
			}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Guest = __webpack_require__(203);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        null,
	        this.state.showInputBar ? React.createElement(InputBar, null) : null
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FirebaseTokenGenerator = __webpack_require__(202);
	...
	module.exports = {
		...
		//OLD HOST
		authHost: function authHost(req, res) {
		...
		//GUEST
		authGuest: function authGuest(req, res) {
	...
	var Guest = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', placeholder: 'Playlist Code' })
	    );
	  }
